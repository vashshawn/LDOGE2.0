...
//        txNew.vout[0].SetEmpty();
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of(90).convert_to_container<std::vector<unsigned char>>();
        base58Prefixes[SCRIPT_ADDRESS] = list_of(8).convert_to_container<std::vector<unsigned char>>();
